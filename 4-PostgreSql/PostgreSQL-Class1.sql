...
VALUES 
	 ...
	 (3, 'thirduser', 'third@gmail.com'),
	 (4, 'fourthuser', 'fourth@gmail.com'),
	 (5, 'fifthuser', 'fifth@gmail.com'),
	 (6, 'sixthuser', 'sixth@gmail.com');
...
--Filtering rows base on a where condition
SELECT * FROM users
WHERE email = 'test@gmail.com'

--Updating rows using update if no filter is provided will update every single row in the table
INSERT INTO users (id,username,email)
...
--Deleting rows using delete (same applies as update)
DELETE 
FROM users
WHERE id = 5;
